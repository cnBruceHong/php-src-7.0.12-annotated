...
/* Errors 信息提示宏定义 */
#define UPLOAD_ERROR_OK   0  /* File upload successful 文件上传成功 */
#define UPLOAD_ERROR_A    1  /* Uploaded file exceeded upload_max_filesize 上传的文件的大小超过最大限制  */
#define UPLOAD_ERROR_B    2  /* Uploaded file exceeded MAX_FILE_SIZE 上传的文件数量超过最大文件数量限制 */
#define UPLOAD_ERROR_C    3  /* Partially uploaded 分批上传 */
#define UPLOAD_ERROR_D    4  /* No file uploaded 上传的文件为空 */
#define UPLOAD_ERROR_E    6  /* Missing /tmp or similar directory 未找到/tmp这类文件夹 */
